...
img = Image.open(f'{storageDir}images\\processing\\{videoID}\\{videoName}_{imageNumber}.png')
...
with open(f'{storageDir}\\output\\{videoID}\\{videoName}_{imageNumber}_output.json', 'w', encoding='utf-8') as file:
